...
$pnpm = Get-Pnpm
if (-not (Test-Path (Join-Path $Root "node_modules"))) { Step "node_modules missing; running pnpm install"; & $pnpm install --store-dir (Join-Path $Root ".dayz-aio-runtime\pnpm-store") }
