...
export function initDatabase() {
  ...
  const rconRows = getDb().prepare("SELECT id, rcon_password as rconPassword FROM servers WHERE rcon_password IS NOT NULL AND rcon_password != ''").all() as Array<{ id: string; rconPassword: string }>;
